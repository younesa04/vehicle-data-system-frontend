...
export const CreateShipmentModal = ({ 
  ...
  // Load existing shipment items if editing
  useEffect(() => {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              >
                <div className="text-left">
                  ...
                  <div className="text-xs mt-1">Supplier → Warehouse</div>
                </div>
              </button>
              ...
              >
                <div className="text-left">
                  ...
                  <div className="text-xs mt-1">Warehouse → Client</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">
              🚗 Vehicles in this Shipment ({shipmentItems.length})
            </h3>
              ...
              <div className="grid grid-cols-12 gap-3">
                ...
                <div className="col-span-2 flex items-end">
                  <button
                    ...
                    className="w-full px-3 py-1.5 bg-green-600 text-white text-sm font-medium rounded hover:bg-green-700"
                  >
                    + Add
                  </button>
                </div>
                  ...
                  <div key={index} className="flex items-center gap-3 bg-white dark:bg-slate-800 p-3 rounded border border-gray-200 dark:border-slate-700">
                    <div className="flex-1">
                      <div className="text-sm font-medium text-slate-900 dark:text-white">
                        {item.vin} - {item.vehicleMake} {item.vehicleModel}
                      </div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            >
              {loading 
                ? (editShipment ? 'Updating...' : 'Creating...') 
                : (editShipment 
                    ? `Update Shipment (${shipmentItems.length} vehicles)` 
                    : `Create Shipment (${shipmentItems.length} vehicles)`
                  )
              }
            </button>
          </div>
